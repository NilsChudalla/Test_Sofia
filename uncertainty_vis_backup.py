...
#logo_URL = 'https://raw.githubusercontent.com/NilsChudalla/Test_Sofia/main/CGRE logo.png'
logo_URL = 'CGRE_logo.svg'
...
uncert_df = pd.read_csv('Uncertainty_table.csv', delimiter=';', index_col=[0])
st.table(uncert_df)
